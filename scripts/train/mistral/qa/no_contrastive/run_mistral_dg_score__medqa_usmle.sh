...
###### Training ######
for seed in 0; do
  python3 -u mistral_dg_scores.py --dataset $dataset \
  ...
  > logs/train_mistraldg_scores_${dataset}__enc-sapbert__k${k}__gnndim${gnndim}__bs${bs}__sl${sl}__unfrz${unfrz}__seed${seed}__${dt}.log.txt
done
