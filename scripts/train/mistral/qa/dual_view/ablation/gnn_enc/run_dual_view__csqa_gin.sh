...
###### Training ######
for seed in 2; do
  python3 -u src/train/qa/ablation/mistral_dual_view_gin.py --dataset $dataset \
  ...
  > logs/ablation/qa/gnn_enc/${dataset}/train_gin_mistral_dual_view_${model_prefix}_${dataset}__enc-__k${k}__gnndim${gnndim}__bs${bs}__seed${seed}__${dt}.log.txt
done
