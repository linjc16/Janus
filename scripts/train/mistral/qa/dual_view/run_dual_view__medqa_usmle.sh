...
for seed in 0 1 2; do
  python3 -u src/train/mistral_dg_scores_only_text_embs_dual_view.py --dataset $dataset \
  ...
  > logs/dual_view/${dataset}/train_${dataset}__enc-sapbert__k${k}__gnndim${gnndim}__bs${bs}__sl${sl}__unfrz${unfrz}__seed${seed}__${dt}.log.txt
done
