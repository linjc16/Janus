...
from modeling.qa.modeling_mistral_only_text_embs import *
...
def train(args):
    ...
    grouped_parameters = [
        ...
        {'params': [p for n, p in model.fc_view2.named_parameters() if not any(nd in n for nd in no_decay)], 'weight_decay': args.weight_decay, 'lr': args.decoder_lr},
        {'params': [p for n, p in model.fc_view2.named_parameters() if any(nd in n for nd in no_decay)], 'weight_decay': 0.0, 'lr': args.decoder_lr},
    ]
