...
from modeling.pair_classification import modeling_greaselm
...
if __name__ == '__main__':
    ...
    # Data
    parser.add_argument('--train_adj', help="The path to the retrieved KG subgraphs of the training set.")
    parser.add_argument('--dev_adj', help="The path to the retrieved KG subgraphs of the dev set.")
    parser.add_argument('--test_adj', help="The path to the retrieved KG subgraphs of the test set.")
    ...
    parser.add_argument('--info_exchange', default=True, choices=[True, False, "every-other-layer"], help="Whether we have the MInt operator in every GreaseLM layer or every other GreaseLM layer or not at all.")
