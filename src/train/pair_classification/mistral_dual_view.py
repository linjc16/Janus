...
from modeling.pair_classification.modeling_mistral_dual_view import *
...
def train(args):
    ...
    if True:
        ...
        dataset = LM_QAGNN_DataLoader(args, args.train_statements, args.train_adj,
                                               ...
                                               subsample=args.subsample, use_cache=args.use_cache, graph_text_embs_path=args.graph_text_embs_path)
    ...
    # try:
        for epoch_id in range(args.n_epochs):
            ...
            for qids, labels, *input_data in tqdm(dataset.train()):
                ...
                if args.fp16:
                    with torch.cuda.amp.autocast():
                        logits_text, logits_graph, contrastive_loss = model(*input_data, layer_id=args.encoder_layer)
