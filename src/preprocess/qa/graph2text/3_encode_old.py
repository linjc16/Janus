...
if __name__ == '__main__':
    ...
    parser.add_argument('--model_name', type=str, choices=['e5-mistral', 'sfr', 'e5-base-v2', 'e5-small-v2', 'e5-large-v2'], default='e5-large-v2')
    ...
    # save the embeddings to .pt
    with open(f'data/{args.dataset}/graph/train.graph.embeddings_cat_query_candidate_filter_{args.model_name}.pt', 'wb') as file:
        torch.save(generated_embeddings, file)