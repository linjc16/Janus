...
DATASET_LIST = ['csqa', 'obqa', 'socialiqa', 'medqa_usmle', 'webnlg', 'scifact', 'fiqa']
...
EMB_PATHS = {
    ...
    'mistral': 'data/cpnet/mistral.ent.npy',
    'dbpedia': 'data/dbpedia/ent_emb.npy',
    'e5-base-v2': 'data/cpnet/e5-base-v2.ent.npy',
    'e5-small-v2': 'data/cpnet/e5-small-v2.ent.npy',
    'e5-large-v2': 'data/cpnet/e5-large-v2.ent.npy',
}
...
def add_optimization_arguments(parser):
    parser.add_argument('--loss', default='cross_entropy', choices=['margin_rank', 'cross_entropy', 'infoNCE'], help='model type')
