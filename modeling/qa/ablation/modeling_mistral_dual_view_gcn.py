...
class QAGNN_Message_Passing(nn.Module):
    def __init__(self, args, k, n_ntype, n_etype, input_size, hidden_size, output_size,
        ...
        self.k = k
        self.gnn_layers = nn.ModuleList([GCNConvE(args, hidden_size, n_ntype, n_etype, self.edge_encoder) for _ in range(k)])
