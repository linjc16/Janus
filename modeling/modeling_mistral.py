...
class LM_QAGNN(nn.Module):
    ...
    def forward(self, *inputs, layer_id=-1, cache_output=False, detail=False):
        ...
        kg_vecs, attn = self.decoder(sent_vecs_query.to(node_type_ids.device),
                                    concept_ids,
        ...
        loss, logits, targets = self.get_cosine_loss(logits, sent_vecs_choice, cl_target.float())
